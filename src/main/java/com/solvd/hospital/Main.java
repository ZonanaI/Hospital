...
public class Main {
    ...
    public static void main (String [] args){
        ...
        while (!command.toLowerCase(Locale.ROOT).equals("f")){
            System.out.println("Initial configuration of hospital main.java.com.solvd.hospital.rooms");
            System.out.println("Enter \"c\" to add new Consulting room, \"d\": Delivery room, \"e\" Emergency room," +
                    ...
                    " \"s\" Surgery room. Enter \"exit\" to close the application, \"f\" to end main.java.com.solvd.hospital.rooms configuration:");
